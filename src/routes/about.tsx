...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About â€” End of the World Atlas" },
      {
        name: "description",
        content:
          "An independent cartographic project documenting the southernmost geographies on Earth, between Chilean Patagonia, Cape Horn and Chilean Antarctica.",
      },
      { property: "og:title", content: "About â€” End of the World Atlas" },
      {
        property: "og:description",
        content: "An independent cartographic project on the Chilean austral frontier.",
      },
      {
        property: "og:url",
        content: "https://end-of-the-world-atlas.endoftheworldatlas.workers.dev/about",
      },
    ],
    links: [
      {
        rel: "canonical",
        href: "https://end-of-the-world-atlas.endoftheworldatlas.workers.dev/about",
      },
    ],
  }),
  component: AboutPage,
      ...
      <section className="pt-40 pb-16 max-w-[1600px] mx-auto px-6 lg:px-12 grid lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-7 space-y-6 text-lg text-muted-foreground leading-relaxed">
          <p>
            ...
            on Navarino Island â€” the southernmost city on Earth and the operational gateway to the
          ...
          <p>
            ...
            network, glaciologists and YagÃ¡n communities to translate a remote austral geography
            into a cinematic atlas anyone can navigate.
          </p>
          <p className="text-glacier italic font-display text-2xl">
            "Mapping the Chilean austral frontier through geography, navigation and southern
            memory."
          </p>
        </div>
      </section>
      ...
      <section className="relative h-[60vh] min-h-[480px] overflow-hidden">
        ...
        <div className="relative h-full max-w-3xl mx-auto px-6 flex items-center text-center">
          <p className="font-display text-3xl md:text-5xl text-ice text-balance leading-[1.15]">
            We document the south so that, even from the north, the world feels finite, fragile â€”
